...
from net_fv_single import NetFV, NetFV_Spatial, NetFV_Temporal
...
def TCN_resnet(
    ...
    print('model before GAP: ', model)
    gap = GlobalAveragePooling1D()(model)
    ...
    dense = Dense(units=n_classes,
                  activation="softmax",
                  kernel_initializer="he_normal")(gap)
...
def main():
    ...
    model = TCN_resnet(n_classes, batch_size=4, dim=(600, 60), gap=1,
