...
from i3d import Inception_Inflated3d, i3d_dense, i3d_dense_299
from inception_v3 import td_cnn_lstm
from project_config_multi import Dataset
from tcn_resnet_multi import tcn_resnet_spatial_enc, TCN_resnet
...
#  test train split
partition, activity_labels, impairment_labels = split_test_train(config.dump_dir_rgb)
...
# models
model = i3d_dense_299(include_top=False,
                      weights='rgb_imagenet_and_kinetics',
                      n_classes=config.params['n_classes'],
                      input_shape=config.params['rgb_dim'], )
...
# model = C3D(weights='sports1M', n_classes=config.params['n_classes'])
